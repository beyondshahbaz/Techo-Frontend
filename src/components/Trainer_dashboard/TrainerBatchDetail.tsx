...
const TrainerBatchDetail = () => {
  ...
  return (
    <div className="trainer-batch-detail-container">
      <div className="batch-headerTBD">
        {/* <h2> */}
          <span className="text-white text-5xl">Batch: {batchDetail.batch_name}</span><br></br>
          <span className="text-white text-4xl">Center: {batchDetail.center}</span>
        {/* </h2> */}
      </div>
