          ...
          <div class="card">
            ...
            <div class="card-body min-bodyHeight">
              ...
              <p className="card-text">
                {" "}
                <span className="fw-bold">Status:</span>Phase two
                Completed. Phase Three to be Started.
              </p>
              <p className="card-text">
                {" "}
        ...
        <div className="col-xxl-4 col-xl-4 col-md-4">
          <div class="card">
            ...
            <div class="card-body min-bodyHeight">
              ...
              <p className="card-text">
                {" "}
                <span className="fw-bold">Technology Stack:</span>Backend: Django Rest Framework, Frontend: React Native
              </p>
            </div>
          </div>
        </div>
        <div className="col-xxl-4 col-xl-4 col-md-4">
          <div class="card">
            ...
            <div class="card-body min-bodyHeight">
              ...
              <p className="card-text">
                <span className="fw-bold">Status:</span> Completed (Being enchaced)
              </p>
              <p className="card-text">
                <span className="fw-bold">Technology Stack:</span>Python and React.js
              </p>
            </div>
          </div>
        </div>
